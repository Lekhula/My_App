...
public class MapsActivity2 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try{
            ...
            LatLng places = new LatLng(lat,lon);

            mMap.addMarker(new MarkerOptions().position(places).title(PlaceName));
            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(places, 30));
